...
# preprocessing.spectrogram.specgram_mtplt function.

# Script imports:
import os
import argparse
from util.towav import sox_convert
from preprocessing.spectrogram import specgram_mtplt
    ...
    for i, line in enumerate(file_names):
        ...
        try:
            ...
            if file_format != 'wav':
                ...
                specgram_mtplt(audiopath=wav_dir + os.sep + wav_file_name,
                               name=file_name)
